...
# Adicione margemLucro como variável global no início do código
margemLucro = 0  # Inicializa como 0

def start():
    global CARTEIRA, flag, vendas, ultimaCompra, isOpened, margemLucro  # Inclua margemLucro como global
    ...
    if rsi < 35 and ((CARTEIRA - valorCompra) >= 0) and not isOpened:  # Só compra se o valor da carteira não ficar negativo
    ...
    elif rsi > 65 and isOpened and (valorVenda > (ultimaCompra + margemLucro)):  # Só vende se o valor for maior que a última compra + lucro
        ...
        print("Aguardando")
        print(f"Última compra: {ultimaCompra}")
